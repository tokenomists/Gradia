...
export default function TeacherDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#fcf9ea]">
      {/* Navbar */}
      <nav className="bg-[#d56c4e] text-white py-4 px-6 shadow-md">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <Link href="/" className="text-3xl font-bold italic">Gradia</Link>
          <div className="flex space-x-6">
            <Link href="/tests" className="hover:underline text-lg font-medium">Tests</Link>
            <Link href="/analysis" className="hover:underline text-lg font-medium">Analysis</Link>
            <div className="h-10 w-10 rounded-full bg-white shadow-md border-2 border-white overflow-hidden">
              <Image 
                src="/tokenomists-logo.png" 
                width={40}
                height={40}
                alt="Profile" 
